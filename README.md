...
More information about the archiving project can be found on the ArchiveTeam wiki: [Madden GIFERATOR](http://archiveteam.org/index.php?title=Madden_GIFERATOR)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "Madden GIFERATOR Discovery" project in the Warrior interface.
...
### For Debian/Ubuntu:
    ...
    pip install seesaw requests
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/giferator-discovery.git; cd giferator-discovery;" archiveteam
    screen su -c "cd /home/archiveteam/giferator-discovery/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, giferator-discovery will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/giferator-discovery/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
